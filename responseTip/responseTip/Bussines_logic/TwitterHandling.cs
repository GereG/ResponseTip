...
/*        internal static void twitterizerAuthentification()
        ...
        //        private DesktopPlatformAdaptor dpa = new DesktopPlatformAdaptor();

        //       BoxKite.Twitter.Authentication.TwitterAuthenticator
        //        TwitterAuthenticator("7KnmZUfUmtWCxmKJ4kIXcsgEa", "YxqsqNVbagz8BIt3dxK9WNuoqbfW3Vl5ozq7ZnMHxwNGhr9inw", DesktopPlatformAdaptor);
        //        var twtauth=new TwitterAuthenticator();
        //        TwitterAuthenticator Twitterauth = new TwitterAuthenticator("7KnmZUfUmtWCxmKJ4kIXcsgEa", "YxqsqNVbagz8BIt3dxK9WNuoqbfW3Vl5ozq7ZnMHxwNGhr9inw", dpa);
        ...
        /*       public class Twitter
               {
                   public const string OauthVersion = "1.0"; public const string OauthSignatureMethod = "HMAC-SHA1";
                   ...
                   public string GetMentions(int count)
                   {
                       ...
                       var requestParameters = new System.Collections.Generic.SortedDictionary();
                       requestParameters.Add("count", count.ToString());
                       requestParameters.Add("include_entities", "true");
                       var response = GetResponse(resourceUrl, Method.GET, requestParameters); return response;
                   }
